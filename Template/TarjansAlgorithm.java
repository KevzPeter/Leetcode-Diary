class Solution {
    public List<List<Integer>> criticalConnections(int n, List<List<Integer>> connections) {
        ...
        if(connections.size()==0) return res;
    ...
    private void dfs(int node, int parent, boolean vis[], int ins[], int low[], List<List<Integer>> adj, int timer, List<List<Integer>> res){
        vis[node] = true;
